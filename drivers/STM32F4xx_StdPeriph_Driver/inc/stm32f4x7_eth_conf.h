...
#ifdef USE_Delay
  #include "FreeRTOS.h"    /* Header file where the Delay function prototype is exported */
...
/* The YT8512C PHY status register  */
#define PHY_SR                 ((uint16_t)0x0011) /* PHY status register Offset */
#define PHY_SPEED_STATUS       ((uint16_t)(3 << 14)) /* PHY Speed mask  1:10Mb/s       0:100Mb/s*/
#define PHY_DUPLEX_STATUS      ((uint16_t)(1 << 13)) /* PHY Duplex mask 1:Full duplex  0:Half duplex*/
